...
import './Map.css';
import '../styles/vehicle-markers.css';
...
// Helper controller to get map instance
...
const Map = () => {
  ...
  // Map instance state - needed for vehicle tracking
  ...
  const [layerVisibility, setLayerVisibility] = useState({
    ...
    metroStations: true,
    tramStations: true,
    lightRailStations: true,
    trainRoutes: true,
    metroRoutes: true,
    tramRoutes: true,
    lightRailRoutes: true,
    liveVehicles: true  // Added this for vehicle tracking
  });
  ...
  const toggleControls = [
    ...
    { id: 'liveVehicles', label: 'Show Live Vehicles', checked: layerVisibility.liveVehicles } // Added this for vehicle tracking
  ];
    ...
    <div>
      <Stack direction={'column'} spacing={2} alignItems={'center'}>
        ...
        >
          ...
          {/* Live Vehicle Tracking - Added from CODE_1 */}
          {layerVisibility.liveVehicles && mapInstance && (
            <VehicleContainer map={mapInstance} />
          )}
        </MapContainer>
